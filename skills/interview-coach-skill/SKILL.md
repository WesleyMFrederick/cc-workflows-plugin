...
- kickoff creates a new profile and populates Resume Analysis from resume analysis. Also persists Interview Readiness Assessment and Coaching Plan (timeline-adjusted action plan with commands). Initializes empty sections: Meta-Check Log, Active Coaching Strategy, Interview Loops, Coaching Notes.
